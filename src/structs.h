...
struct capitol_5_data {
	// admisibilele
	real_t sigma_sa;
	real_t sigma_fa;

	// a.) dintre arbore si roata conducatoare
	real_t bp_a;
	real_t hp_a;
	real_t Lp_min_a;
	real_t Lp_max_a;
...
struct data {
	...
	struct capitol_5_data pene_paralele;			// din capitolul 5
	struct capitol_6_data verificare_arbore;		// din capitolul 6
};
